...
// Creation de la collection "cities"
// cityModel.create(cities)
// .then(console.log)
// .catch(console.error);

// 1. Affichez la population totale par département avec 
// cityModel.aggregate()   
//     .group({
//         _id:'$department', populationTotal: {$sum:"$population"}
//         })
// .then(console.log)
// .catch(console.error);

// 1. Affichez la population totale par département avec 
// cityModel.aggregate([{$group:{_id:"$department",populationTotal:{$sum:"$population"}}}])  
// .then(console.log)
// .catch(console.error);
...
// 3. Triez ces infos par population décroissant
// cityModel.aggregate()   
//     .sort({
//         populationTotal: 1
//         })
...
// 3. Triez ces infos par population croissant
// cityModel.aggregate()   
//     .sort({
//         populationTotal: -1
//         })
...
mongoose.connect('mongodb://localhost:27017/census', (error) => {
    if (error) {
        console.error(error);
        process.exit(1);
    }
